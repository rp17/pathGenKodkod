...
public class ExperimentalPathfinder {
	...
	public ExperimentalPathfinder() {														/* Path */
	...
	public static String find_loop_path(SubGraph jpx, Integer forcediterations) {
		...
		//	PrintWriter out = new PrintWriter(outFile);
			...
			final ExperimentalPathfinder model = new ExperimentalPathfinder();							/* Path		Path */
	...
	public static void main(String[] argc){
		...
		ExperimentalPathfinder.find_loop_path(jpx, 2);
